...
define([
    ...
    'Antiquty_Atq/js/action/update-item',
    'Antiquty_Atq/js/action/gift-message-item',
    'mage/url',
    'mage/translate',
    'Magento_Ui/js/modal/modal',
    'Antiquty_Atq/js/action/payment-total-information',
    'Antiquty_Atq/js/options/configurable',
    'priceOptions'
    ...
    return Component.extend({
        defaults: {
            template: 'Antiquty_Atq/container/summary/item/details'
        },
        ...
        getPOAText: function (poaurl) {

            let url = 'https://formesutiles.com/poa.php?sku=' + poaurl;
